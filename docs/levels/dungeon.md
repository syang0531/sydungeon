...
flowchart LR
  ...
  P_shaft_first -- 1 --> E_shaft_1
  P_shaft_second -- 1 --> E_shaft_2
  P_shafts -- 3 --> E_shaft
  P_shafts -- 2 --> E_hub
...
| `shaft_first` | `shaft_caps` | `shaft_1` 1 |
| `shaft_second` | `shaft_caps` | `shaft_2` 1 |
...
|---|---|---|
| `entrance` | (0, 0, 0) | 시작 풀 |
| `shaft_1` | (0, -21, 0) | entrance의 아래 door 직소 |
| `shaft_2` | (0, -42, 0) | shaft_1의 아래 door 직소 |

![뼈대](img/dungeon/_assembly.svg)

![조각 지도](img/dungeon/_assembly_pieces.svg)
...
**뚫린 면** — 서: z 0–6, y 1–6 (27칸) / 동: z 0–6, y 1–6 (27칸) / 북: x 0–6, y 6–6 (7칸) / 남: x 0–6, y 1–6 (27칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 돌벽돌 136, 사다리 5, 직소 1, 랜턴 1
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `stair_foot` | `door` | `dungeon/passages` |
...
**어느 풀에 있나** — `shaft_first` (가중치 1)

| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 2) | ◇ 아래 | `door` | `door` | `dungeon/shaft_second` |
| (3, 20, 2) | ◆ 위 | `door` | `door` | `dungeon/shafts` |

**블록** — 돌벽돌 1006, 사다리 21, 직소 2

![shaft_1](img/dungeon/shaft_1.svg)
...
![shaft_2](img/dungeon/shaft_2.svg)
