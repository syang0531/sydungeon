...
|---|---|---|---|---|
| (10, 0, 11) | ◇ 아래 | `dwf_down` | `dwf_down` | `dwarf/down` |

**뚫린 면** — 서: z 0–20, y 6–16 (109칸) / 동: z 0–20, y 6–16 (109칸) / 북: x 0–20, y 1–16 (120칸) / 남: x 0–20, y 12–16 (105칸) / 위: x 0–20, z 0–20 (441칸)

**블록** — 심층암 벽돌 679, 윤나는 심층암 530, 심층암 타일 433, 응회암 벽돌 88, 조각한 심층암 20, 쇠사슬 6, 철창 4, 랜턴 4
...
y = 0   x →동, z ↓남
  ...
  dddddddddyHyddddddddd
  dddddddddyJyddddddddd
  ddddddddddddddddddddd
  ddddddddddddddddddddd
  ddddddddddddddddddddd
  ddddddddddddddddddddd
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `dwf_down` | `dwf_down` | `dwarf/deep` |
| (3, 20, 4) | ◆ 위 | `dwf_down` | `dwf_down` | `—` |
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `dwf_hall` | `dwf_hall` | `dwarf/hall_first` |
| (3, 20, 4) | ◆ 위 | `dwf_down` | `dwf_down` | `—` |
...
| (3, 6, 4) | ◆ 위 | `dwf_hall` | `dwf_hall` | `—` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 북: x 2–4, y 1–4 (12칸) / 남: x 2–4, y 1–4 (12칸)

**블록** — 돌 116, 심층암 타일 46, 화강암 15, 사다리 6, 심층암 벽돌 5, 직소 4, 윤나는 심층암 1, 랜턴 1
