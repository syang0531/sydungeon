...
> 이 문서는 `python tools/gen_level_doc.py tomb`가 만든다. 조각을 고치면 다시 돌린다. 그림과 표는 게임이 읽는 파일(`structure/tomb/*.nbt`, `worldgen/**`)에서 그대로 읽어 온 것이라 모드와 어긋날 수 없다. 설명 문장만 사람이 쓴다 (`tools/gen_level_doc.py`의 `INTRO`·`NOTES`).
...
| 바이옴 | `#sydungeon:has_structure/tomb` |
...
|---|---|---|
| `head` | (0, 0, 0) | 시작 풀 |
| `shaft` | (0, -21, 0) | head의 아래 tomb_down 직소 |
| `hub` | (0, -28, 0) | shaft의 아래 tomb_cell 직소 |
| `store` | (0, -28, -7) | hub의 북 tomb_cell 직소 |

![뼈대](img/tomb/_assembly.svg)

![조각 지도](img/tomb/_assembly_pieces.svg)
...
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `tomb_down` | `tomb_down` | `tomb/down` |

**뚫린 면** — 서: z 0–6, y 2–7 (42칸) / 동: z 0–6, y 2–7 (42칸) / 북: x 0–6, y 1–7 (45칸) / 남: x 0–6, y 2–7 (42칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 깎은 사암 68, 모래 40, 조각한 사암 2, 사다리 1, 직소 1

![head](img/tomb/head.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `tomb_cell` | `tomb_cell` | `tomb/first` |
| (4, 20, 3) | ◆ 위 | `tomb_down` | `tomb_down` | `—` |

**블록** — 사암 806, 깎은 사암 200, 사다리 21, 직소 2

![shaft](img/tomb/shaft.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `tomb_cell` | `tomb_cell` | `tomb/store` |
| (0, 0, 3) | ◀ 서 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (3, 0, 6) | ▼ 남 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (4, 6, 3) | ◆ 위 | `tomb_cell` | `tomb_cell` | `—` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 북: x 2–4, y 1–4 (12칸) / 남: x 2–4, y 1–4 (12칸)

**블록** — 사암 116, 깎은 사암 61, 사다리 6, 조각한 사암 5, 직소 4, 랜턴 1

![hub](img/tomb/hub.svg)
...
**블록** — 사암 136, 깎은 사암 69, 조각한 사암 4, 아카시아 울타리 1, 랜턴 1, 직소 1, 상자 1, 통 1

![store](img/tomb/store.svg)
...
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (6, 0, 3) | ▶ 동 | `tomb_cell` | `tomb_cell` | `tomb/cells` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 동: z 2–4, y 1–4 (12칸)

**블록** — 사암 127, 깎은 사암 65, 직소 2, 조각한 사암 2

![passage](img/tomb/passage.svg)
...
**블록** — 사암 127, 깎은 사암 65, 직소 2, 조각한 사암 1, 랜턴 1

![corner](img/tomb/corner.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (0, 0, 3) | ◀ 서 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (6, 0, 3) | ▶ 동 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
| (3, 0, 6) | ▼ 남 | `tomb_cell` | `tomb_cell` | `tomb/cells` |
...
**블록** — 사암 109, 깎은 사암 57, 조각한 사암 12, 직소 4

![cross](img/tomb/cross.svg)
...
**블록** — 사암 127, 깎은 사암 56, 조각한 사암 9, 직소 2, 거미줄 1, 몬스터 스포너 1

![den](img/tomb/den.svg)
...
**블록** — 사암 136, 깎은 사암 69, 모래 4, 직소 1, 상자 1, 랜턴 1

![nook](img/tomb/nook.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `tomb_cell` | `tomb_cell` | `tomb/caps` |

**블록** — 사암 35, 깎은 사암 13, 직소 1

![cap](img/tomb/cap.svg)
