...
> 이 문서는 `python tools/gen_level_doc.py well`가 만든다. 조각을 고치면 다시 돌린다. 그림과 표는 게임이 읽는 파일(`structure/well/*.nbt`, `worldgen/**`)에서 그대로 읽어 온 것이라 모드와 어긋날 수 없다. 설명 문장만 사람이 쓴다 (`tools/gen_level_doc.py`의 `INTRO`·`NOTES`).
...
바이옴: plains · sunflower_plains · meadow · forest · flower_forest · birch_forest · old_growth_birch_forest

| 항목 | 값 |
|---|---|
| 생성 단계 | `underground_structures` |
| 바이옴 | `#sydungeon:has_structure/well` |
...
|---|---|---|
| `head` | (0, 0, 0) | 시작 풀 |
| `shaft` | (0, -21, 0) | head의 아래 well_down 직소 |
| `hub` | (0, -28, 0) | shaft의 아래 well_cell 직소 |
| `store` | (0, -28, -7) | hub의 북 well_cell 직소 |

![뼈대](img/well/_assembly.svg)

![조각 지도](img/well/_assembly_pieces.svg)
...
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `well_down` | `well_down` | `well/down` |

**뚫린 면** — 서: z 0–6, y 1–7 (49칸) / 동: z 0–6, y 1–7 (49칸) / 북: x 0–6, y 1–7 (49칸) / 남: x 0–6, y 1–7 (49칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 조약돌 39, 자갈 24, 참나무 원목 9, 사다리 1, 쇠사슬 1, 직소 1

![head](img/well/head.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `well_cell` | `well_cell` | `well/first` |
| (4, 20, 3) | ◆ 위 | `well_down` | `well_down` | `—` |

**블록** — 돌 806, 안산암 200, 사다리 21, 직소 2

![shaft](img/well/shaft.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `well_cell` | `well_cell` | `well/store` |
| (0, 0, 3) | ◀ 서 | `well_cell` | `well_cell` | `well/cells` |
| (3, 0, 6) | ▼ 남 | `well_cell` | `well_cell` | `well/cells` |
| (4, 6, 3) | ◆ 위 | `well_cell` | `well_cell` | `—` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 북: x 2–4, y 1–4 (12칸) / 남: x 2–4, y 1–4 (12칸)

**블록** — 돌 116, 조약돌 46, 안산암 15, 사다리 6, 돌벽돌 5, 직소 4, 랜턴 1

![hub](img/well/hub.svg)
...
**블록** — 돌 136, 조약돌 48, 안산암 21, 돌벽돌 4, 참나무 울타리 1, 랜턴 1, 직소 1, 상자 1

![store](img/well/store.svg)
...
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `well_cell` | `well_cell` | `well/cells` |
| (6, 0, 3) | ▶ 동 | `well_cell` | `well_cell` | `well/cells` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 동: z 2–4, y 1–4 (12칸)

**블록** — 돌 127, 조약돌 47, 안산암 18, 직소 2, 돌벽돌 2

![passage](img/well/passage.svg)
...
**블록** — 돌 127, 조약돌 47, 안산암 18, 직소 2, 돌벽돌 1, 랜턴 1

![corner](img/well/corner.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `well_cell` | `well_cell` | `well/cells` |
| (0, 0, 3) | ◀ 서 | `well_cell` | `well_cell` | `well/cells` |
| (6, 0, 3) | ▶ 동 | `well_cell` | `well_cell` | `well/cells` |
| (3, 0, 6) | ▼ 남 | `well_cell` | `well_cell` | `well/cells` |
...
**블록** — 돌 109, 조약돌 45, 안산암 12, 돌벽돌 12, 직소 4

![cross](img/well/cross.svg)
...
**블록** — 돌 127, 조약돌 38, 안산암 18, 돌벽돌 9, 직소 2, 거미줄 1, 몬스터 스포너 1

![den](img/well/den.svg)
...
**블록** — 돌 136, 조약돌 48, 안산암 21, 자갈 4, 직소 1, 상자 1, 랜턴 1

![nook](img/well/nook.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `well_cell` | `well_cell` | `well/caps` |

**블록** — 돌 35, 안산암 13, 직소 1

![cap](img/well/cap.svg)
