...
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `lht_down` | `lht_down` | `light/down` |

**뚫린 면** — 서: z 0–6, y 1–26 (40칸) / 동: z 0–6, y 21–26 (24칸) / 북: x 0–6, y 8–26 (44칸) / 남: x 0–6, y 8–26 (20칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 돌벽돌 411, 이끼 낀 돌벽돌 71, 금 간 돌벽돌 69, 사다리 23, 어두운 프리즈머린 21, 풍화된 구리 18, 프리즈머린 벽돌 5, 바다 랜턴 2
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `lht_down` | `lht_down` | `light/sump_first` |
| (3, 20, 4) | ◆ 위 | `lht_down` | `lht_down` | `—` |
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `lht_down` | `lht_down` | `light/dive` |
| (3, 6, 4) | ◆ 위 | `lht_down` | `lht_down` | `—` |

**뚫린 면** — 아래: x 3–3, z 3–3 (1칸)

**블록** — 돌 143, 돌벽돌 52, 안산암 24, 사다리 6, 직소 2, 랜턴 2, 상자 1, 통 1
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 4) | ◇ 아래 | `lht_sea` | `lht_sea` | `light/sea_first` |
| (3, 13, 4) | ◆ 위 | `lht_down` | `lht_down` | `—` |

**뚫린 면** — 위: x 3–3, z 3–3 (1칸)

**블록** — 돌 517, 안산암 141, 물 13, 프리즈머린 벽돌 12, 직소 2
...
| (3, 6, 4) | ◆ 위 | `lht_sea` | `lht_sea` | `—` |

**블록** — 물 155, 돌 116, 어두운 프리즈머린 46, 안산암 15, 프리즈머린 벽돌 5, 직소 4, 바다 랜턴 2
