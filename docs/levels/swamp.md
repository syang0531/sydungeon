...
큰 오두막을 받치는 것. 21×9×21이고 **네 귀퉁이 기둥과 해치 기둥, 사다리와 그 공기 통로만**
들어 있다. 나머지는 안 쓰므로 물이 그대로 남는다.
...
**뚫린 면** — 서: z 1–19, y 0–8 (171칸) / 동: z 1–19, y 0–8 (171칸) / 북: x 1–19, y 0–8 (171칸) / 남: x 1–19, y 0–8 (171칸) / 아래: x 0–20, z 0–20 (435칸) / 위: x 0–20, z 0–20 (435칸)

**블록** — 짙은 참나무 원목 43, 사다리 9, 직소 2
