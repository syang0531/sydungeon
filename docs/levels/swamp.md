...
| `pilings` | `minecraft:empty` | `pilings` 1 |
...
| `pilings` | (0, -9, 0) | great_hut의 아래 swamp_down 직소 |
| `shaft` | (7, -30, 7) | pilings의 아래 swamp_down 직소 |
| `cellar_hub` | (7, -37, 7) | shaft의 아래 swamp_cellar 직소 |
| `approach_1` | (7, -37, 14) | cellar_hub의 남 swamp_cellar 직소 |
| `approach_2` | (14, -37, 14) | approach_1의 동 swamp_cellar 직소 |
| `approach_3` | (21, -37, 14) | approach_2의 동 swamp_cellar 직소 |
...
|---|---|---|---|---|
| (11, 0, 10) | ◇ 아래 | `swamp_down` | `swamp_down` | `swamp/pilings` |
...
**뚫린 면** — 서: z 0–20, y 0–10 (90칸) / 동: z 0–20, y 0–10 (90칸) / 북: x 0–20, y 0–10 (90칸) / 남: x 0–20, y 0–10 (90칸) / 아래: x 0–20, z 0–20 (428칸) / 위: x 0–20, z 0–20 (441칸)

**블록** — 짙은 참나무 판자 1149, 짙은 참나무 반 블록 441, 짙은 참나무 원목 35, 진흙 벽돌 13, 직소 5, 랜턴 4, 사다리 4, 양조기 3
...
**어느 풀에 있나** — `pilings` (가중치 1)

| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (11, 0, 10) | ◇ 아래 | `swamp_down` | `swamp_down` | `swamp/down` |
| (11, 8, 10) | ◆ 위 | `swamp_down` | `swamp_down` | `—` |

**뚫린 면** — 서: z 1–19, y 0–8 (171칸) / 동: z 1–19, y 0–8 (171칸) / 북: x 1–19, y 0–8 (171칸) / 남: x 1–19, y 0–8 (171칸) / 아래: x 0–20, z 0–20 (428칸) / 위: x 0–20, z 0–20 (428칸)

**블록** — 짙은 참나무 판자 63, 짙은 참나무 원목 43, 사다리 9, 직소 2

![pilings](img/swamp/pilings.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (0, 12, 3) | ◀ 서 | `swamp_deck` | `swamp_deck` | `swamp/decks` |
| (6, 12, 3) | ▶ 동 | `swamp_deck` | `swamp_deck` | `swamp/decks` |

**뚫린 면** — 서: z 0–6, y 0–19 (105칸) / 동: z 0–6, y 0–19 (105칸) / 북: x 0–6, y 0–19 (102칸) / 남: x 0–6, y 0–19 (102칸) / 아래: x 0–6, z 0–6 (45칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 짙은 참나무 원목 48, 짙은 참나무 판자 47, 짙은 참나무 울타리 18, 직소 2, 랜턴 2
...
**블록** — 짙은 참나무 원목 48, 짙은 참나무 판자 47, 짙은 참나무 울타리 18, 직소 2, 랜턴 2, 몬스터 스포너 1
...
|---|---|---|---|---|
| (0, 12, 3) | ◀ 서 | `swamp_deck` | `swamp_deck` | `swamp/decks` |
| (3, 12, 6) | ▼ 남 | `swamp_deck` | `swamp_deck` | `swamp/decks` |

**뚫린 면** — 서: z 0–6, y 0–19 (105칸) / 동: z 0–6, y 0–19 (102칸) / 북: x 0–6, y 0–19 (102칸) / 남: x 0–6, y 0–19 (105칸) / 아래: x 0–6, z 0–6 (45칸) / 위: x 0–6, z 0–6 (49칸)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 12, 0) | ▲ 북 | `swamp_deck` | `swamp_deck` | `swamp/decks` |
| (0, 12, 3) | ◀ 서 | `swamp_deck` | `swamp_deck` | `swamp/decks` |
| (6, 12, 3) | ▶ 동 | `swamp_deck` | `swamp_deck` | `swamp/decks` |
| (3, 12, 6) | ▼ 남 | `swamp_deck` | `swamp_deck` | `swamp/decks` |

**뚫린 면** — 서: z 0–6, y 0–19 (105칸) / 동: z 0–6, y 0–19 (105칸) / 북: x 0–6, y 0–19 (105칸) / 남: x 0–6, y 0–19 (105칸) / 아래: x 0–6, z 0–6 (45칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 짙은 참나무 원목 48, 짙은 참나무 판자 45, 짙은 참나무 울타리 12, 직소 4, 랜턴 2
...
**뚫린 면** — 서: z 0–6, y 0–19 (79칸) / 동: z 0–6, y 0–19 (67칸) / 북: x 0–6, y 0–19 (67칸) / 남: x 0–6, y 0–19 (67칸) / 아래: x 0–6, z 0–6 (45칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 짙은 참나무 판자 181, 짙은 참나무 반 블록 49, 짙은 참나무 원목 48, 직소 1, 가마솥 1, 랜턴 1, 상자 1
...
**블록** — 짙은 참나무 판자 181, 짙은 참나무 반 블록 49, 짙은 참나무 원목 48, 직소 1, 가마솥 1, 몬스터 스포너 1, 양조기 1, 상자 1
...
**블록** — 짙은 참나무 판자 181, 짙은 참나무 반 블록 49, 짙은 참나무 원목 48, 진흙 맹그로브 뿌리 5, 직소 1, 상자 1, 몬스터 스포너 1
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `swamp_cellar` | `swamp_cellar` | `swamp/cellar_first` |
| (4, 20, 3) | ◆ 위 | `swamp_down` | `swamp_down` | `—` |

**블록** — 진흙 벽돌 1006, 사다리 21, 직소 2
...
| (4, 6, 3) | ◆ 위 | `swamp_cellar` | `swamp_cellar` | `—` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 동: z 2–4, y 1–4 (12칸) / 남: x 2–4, y 1–4 (12칸)

**블록** — 진흙 벽돌 136, 굳은 진흙 46, 사다리 6, 직소 4, 랜턴 1
