...
> 이 문서는 `python tools/gen_level_doc.py mire`가 만든다. 조각을 고치면 다시 돌린다. 그림과 표는 게임이 읽는 파일(`structure/mire/*.nbt`, `worldgen/**`)에서 그대로 읽어 온 것이라 모드와 어긋날 수 없다. 설명 문장만 사람이 쓴다 (`tools/gen_level_doc.py`의 `INTRO`·`NOTES`).
...
바이옴: swamp · mangrove_swamp

| 항목 | 값 |
|---|---|
| 생성 단계 | `underground_structures` |
| 바이옴 | `#sydungeon:has_structure/mire` |
...
|---|---|---|
| `head` | (0, 0, 0) | 시작 풀 |
| `shaft` | (0, -21, 0) | head의 아래 mire_down 직소 |
| `hub` | (0, -28, 0) | shaft의 아래 mire_cell 직소 |
| `store` | (0, -28, -7) | hub의 북 mire_cell 직소 |

![뼈대](img/mire/_assembly.svg)

![조각 지도](img/mire/_assembly_pieces.svg)
...
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `mire_down` | `mire_down` | `mire/down` |

**뚫린 면** — 서: z 0–6, y 2–7 (42칸) / 동: z 0–6, y 2–7 (42칸) / 북: x 0–6, y 1–7 (45칸) / 남: x 0–6, y 2–7 (42칸) / 위: x 0–6, z 0–6 (49칸)

**블록** — 진흙 벽돌 68, 진흙 40, 굳은 진흙 2, 사다리 1, 직소 1

![head](img/mire/head.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (4, 0, 3) | ◇ 아래 | `mire_cell` | `mire_cell` | `mire/first` |
| (4, 20, 3) | ◆ 위 | `mire_down` | `mire_down` | `—` |

**블록** — 돌 806, 점토 200, 사다리 21, 직소 2

![shaft](img/mire/shaft.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `mire_cell` | `mire_cell` | `mire/store` |
| (0, 0, 3) | ◀ 서 | `mire_cell` | `mire_cell` | `mire/cells` |
| (3, 0, 6) | ▼ 남 | `mire_cell` | `mire_cell` | `mire/cells` |
| (4, 6, 3) | ◆ 위 | `mire_cell` | `mire_cell` | `—` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 북: x 2–4, y 1–4 (12칸) / 남: x 2–4, y 1–4 (12칸)

**블록** — 돌 116, 진흙 벽돌 46, 점토 15, 사다리 6, 굳은 진흙 5, 직소 4, 랜턴 1

![hub](img/mire/hub.svg)
...
**블록** — 돌 136, 진흙 벽돌 48, 점토 21, 굳은 진흙 4, 맹그로브 울타리 1, 랜턴 1, 직소 1, 상자 1

![store](img/mire/store.svg)
...
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `mire_cell` | `mire_cell` | `mire/cells` |
| (6, 0, 3) | ▶ 동 | `mire_cell` | `mire_cell` | `mire/cells` |

**뚫린 면** — 서: z 2–4, y 1–4 (12칸) / 동: z 2–4, y 1–4 (12칸)

**블록** — 돌 127, 진흙 벽돌 47, 점토 18, 직소 2, 굳은 진흙 2

![passage](img/mire/passage.svg)
...
**블록** — 돌 127, 진흙 벽돌 47, 점토 18, 직소 2, 굳은 진흙 1, 랜턴 1

![corner](img/mire/corner.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (3, 0, 0) | ▲ 북 | `mire_cell` | `mire_cell` | `mire/cells` |
| (0, 0, 3) | ◀ 서 | `mire_cell` | `mire_cell` | `mire/cells` |
| (6, 0, 3) | ▶ 동 | `mire_cell` | `mire_cell` | `mire/cells` |
| (3, 0, 6) | ▼ 남 | `mire_cell` | `mire_cell` | `mire/cells` |
...
**블록** — 돌 109, 진흙 벽돌 45, 점토 12, 굳은 진흙 12, 직소 4

![cross](img/mire/cross.svg)
...
**블록** — 돌 127, 진흙 벽돌 38, 점토 18, 굳은 진흙 9, 직소 2, 거미줄 1, 몬스터 스포너 1

![den](img/mire/den.svg)
...
**블록** — 돌 136, 진흙 벽돌 48, 점토 21, 진흙 4, 직소 1, 상자 1, 랜턴 1

![nook](img/mire/nook.svg)
...
| 직소 위치 | 향 | name | target | pool |
|---|---|---|---|---|
| (0, 0, 3) | ◀ 서 | `mire_cell` | `mire_cell` | `mire/caps` |

**블록** — 돌 35, 점토 13, 직소 1

![cap](img/mire/cap.svg)
