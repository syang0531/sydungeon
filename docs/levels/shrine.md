...
|---|---|---|---|---|
| (10, 0, 0) | ▲ 북 | `shr_path` | `shr_path` | `shrine/paths` |
| (0, 0, 10) | ◀ 서 | `shr_path` | `shr_path` | `shrine/paths` |
| (20, 0, 10) | ▶ 동 | `shr_path` | `shr_path` | `shrine/paths` |
| (10, 0, 20) | ▼ 남 | `shr_path` | `shr_path` | `shrine/paths` |
| (14, 1, 10) | ◀ 서 | `shr_path` | `shr_sealed` | `shrine/cellar` |

**뚫린 면** — 서: z 0–20, y 1–17 (299칸) / 동: z 0–20, y 1–17 (299칸) / 북: x 0–20, y 1–17 (299칸) / 남: x 0–20, y 1–17 (299칸) / 위: x 0–20, z 0–20 (441칸)

**블록** — 매끄러운 돌 594, 돌 349, 안산암 담장 128, 윤나는 안산암 82, 벚나무 판자 45, 벚나무 원목 40, 매끄러운 돌 반 블록 32, 껍질 벗긴 벚나무 28
