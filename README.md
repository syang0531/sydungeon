...
**마법사의 성** — 타이가의 돌벽돌·심층암 성. 1층 미로를 지나 중앙 홀에 닿으면 사다리 하나가 지하 성소부터 탑 꼭대기까지 통한다. 2층 도서관에는 **진짜로 쓸 수 있는 마법 부여대**가 책장 열다섯에 둘러싸여 있고, 지하 성소에는 대마법사와 **불 붙이지 않은 네더 포탈 틀**이 있다. 그를 이기면 **엔더의 눈 넷과 불사의 토템**이 나온다.
