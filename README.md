...
**마법사의 탑** — 타이가에 선 높이 86칸의 탑. 아래가 넓고 몸통이 가늘며 꼭대기에서 다시 벌어진다. 산화 구리 지붕이 한 칸씩 좁아지다 피뢰침으로 끝나고, 이끼 낀 돌 몸통에 층마다 구리 띠가 돈다. 서쪽 현관으로 들어가면 연금실과 대계단이 있고, **층마다 계단방이 다른 칸에 있어서** 올라갈 자리를 매 층 찾아다녀야 한다. 미로에도 계단이 섞여 있어 지름길은 매번 다르다. 3층 문 너머는 두 층 높이의 **도서관**이다 — 벽이 전부 책장이고, 바닥 단상의 **마법 부여대**가 책장 열다섯에 둘러싸여 30레벨을 바로 준다. 7층 문 너머는 대마법사의 성소와 **불 붙이지 않은 네더 포탈 틀**. 그를 이기면 **엔더의 눈 넷과 불사의 토템**이 나온다. 8층 계단은 사방이 트인 **옥상 회랑**으로 이어진다.
