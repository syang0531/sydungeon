...
**대피라미드** — 사막에 선 밑변 91칸, 높이 46칸의 사암 피라미드. 북면의 문으로 들어가면 9×9칸 미로가 있고, 중앙 우물의 사다리가 21칸짜리 묘실 바닥 한가운데로 올려보낸다. 올라서는 순간 스포너에 둘러싸인 채로 잠들지 못한 파라오와 싸운다. 이기면 **흑요석 14개와 화염과 강철** — 네더 포탈과 마법 부여대다. 가는 길에는 TNT 압력판, 무너지는 모래 천장, 허스크가 든 모래 소굴이 있다.
