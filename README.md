...
**마법사의 탑** — 타이가에 선 39칸 폭, 56칸 높이의 돌벽돌·심층암 탑. **일곱 층, 층마다 방 스물다섯 칸.** 서쪽 계단실의 사다리가 1층 바닥부터 꼭대기까지 통하고, 층마다 문이 하나씩 열린다. 2층 문 너머는 **3층 높이의 도서관**이다. 벽이 전부 책장이고 회랑이 둘이며, 바닥 단상의 **마법 부여대**가 책장 열다섯에 둘러싸여 30레벨을 바로 준다. 5층 문 너머는 대마법사의 성소와 **불 붙이지 않은 네더 포탈 틀**. 그를 이기면 **엔더의 눈 넷과 불사의 토템**이 나온다.
