...
그다음은 `docs/concepts.md` §9의 순서. CurseForge 프로젝트 1703811에 0.1.0·0.1.1·0.2.0을 배포했다. 0.1.1이 감옥 마무리, 0.2.0이 대피라미드다. 마법사의 탑은 세 번 지었다 — 0.3.0(직육면체), 0.4.0(가는 탑), **0.5.0(사람이 지은 둥근 탑)**. 다음은 **마녀의 늪**(양조를 네더 전에 연다).
